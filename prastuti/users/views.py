...
def userSignup(request):
    if request.method == "POST":
        ...
        if user_form.is_valid():
            ...
            mail_subject = "Activate you annual tech fest account"
            ...
            email.send()
            return HttpResponse('<h1>Please confirm your email address to complete the registration.Please check your spam folder also.If you did not recieve mail please contact <a href="mailto:saurabh.2021ca096@mnnit.ac.in">Annual Tech Fest(saurabh.2021ca096@mnnit.ac.in).</a></h1>')
    else:
...
def userRecovery(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            current_site = get_current_site(request)
            mail_subject = "Change your annual tech fest  password"
